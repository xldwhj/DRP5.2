 ...
 * HISTORY:
 *  1. [2003-3-4 by Jack] ����IFRAME�����˻ᱻҳ��SELECT����ס��BUG!
 *  2. [2003-3-4 by Jack] ��������տؼ�ֵ�Ĺ���
 *  3. [2003-3-5 by Jack] �����˵��û����ꡢ����ʱԭ�����ֵ�����ǵ����
 *  4. [2003-3-5 by Jack] ͨ��ʹ��DXImageTransform.Microsoft.Shadow��ʵ��IFRAME����ӰЧ��
 *                        ���˾�ֻ����IE5.5��ʹ�ÿɼӿ���������ٶȣ���IE5.0�л���ʹ��ԭ���Ĳ�����Ӱ�ķ���
 *  5. [2003-3-6 by Jack] ����������һ�����ɸÿؼ��ķ�����<script>createDateBox("Name", "2003-3-6")</script>
 *                        ���еڶ�������Ϊ��ѡ����
 */
...
function createCldTabFrm(){
	...
	_TD.innerHTML = "<table cellspacing=0 cellpadding=0 class=calendar style='border:0px solid;width:100%'>"
		+ "<tr><td title=   'ѡ�����'style='cursor:hand'onclick=\"parent._bHaveSelectNewValue=true;parent.setTargetFormaValue(" + _dftD.getFullYear() + "," + (_dftD.getMonth() + 1) + "," + _dftD.getDate() + ");parent.hideCldTabFrm();return;parent.fillCldTabFrm(" + _dftD.getFullYear() + "," + _dftD.getMonth() + "," + _dftD.getDate() + ");\">"
		+ "<b>&nbsp;<img src='" + _imgBgToday1.src + "' width=30px>����: " + _dftD.getFullYear() + "-" + (_dftD.getMonth() + 1) + "-" + _dftD.getDate()
		+ "</td>"
		+ "<td width=30px>"
