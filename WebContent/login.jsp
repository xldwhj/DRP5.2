<%@page import="com.bjpowernode.drp.sysmgr.manager.PasswordNotCorrentException"%>
<%@page import="com.bjpowernode.drp.sysmgr.manager.UserNotFountException"%>
...
<%
	...
	if("login".equals(command)){
		...
		try{
			...
			session.setMaxInactiveInterval(60*60);//设置session超时，此处优先，web.xml中配置失效
			response.sendRedirect("main.jsp");
		}catch(UserNotFountException e){
			out.println(e.getMessage());
			//out.println("<script>alert('用户代码不正确！');</script>");
											...
											<TABLE cellSpacing=5 cellPadding=0 align=center
												...
												<TBODY>
													...
													<TR>
														...
														<TD align=left>
															<INPUT name="userId" type="text" size="20" maxlength="20" value=<%=userId %>>
														</TD>
													</TR>
													<TR>
														<TD align=left>
