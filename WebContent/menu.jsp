...
<html>
	...
	OutBarFolder1=new Array("分销商库存管理","images/admin.gif","分销商库存数量初始化","flowcard/inv_init_qty_maint.html","parent.parent.main", "images/admin.gif","分销商库存初始化确认","flowcard/inv_init_qty_confirm.html","parent.parent.main","images/admin.gif","流向单维护","flowcard/flow_card_maint.jsp","parent.parent.main","images/admin.gif","流向单审核","flowcard/flow_card_audit.html","parent.parent.main","images/admin.gif","流向单抽查","flowcard/flow_card_spot_test.html","parent.parent.main","images/admin.gif","流向单复审","flowcard/flow_card_rehear.html","parent.parent.main","images/admin.gif","盘点结果维护","flowcard/checkvou_maint.html","parent.parent.main","images/admin.gif","盘点结果审核","flowcard/checkvou_audit.html","parent.parent.main"); 
	OutBarFolder2=new Array("分销费管理"); 
	OutBarFolder3=new Array("结帐管理"); 
	OutBarFolder4=new Array("付款结算管理"); 
	OutBarFolder5=new Array("统计报表管理","images/admin.gif","分销商级别分布图","statreport/client_level_chart.html","parent.parent.main","images/admin.gif","流向单录入审核报告","statreport/flow_card_audit_report.html","parent.parent.main","images/admin.gif","流向单抽查报告","statreport/flow_card_spot_test_report.html","parent.parent.main","images/admin.gif","分销商月度分销(调拨)明细表","statreport/client_detail_month_per.html","parent.parent.main","images/admin.gif","分销商库存报表","statreport/client_stock_report.html","parent.parent.main"); 
	OutBarFolder6=new Array("基础数据管理","images/admin.gif","会计核算期间维护","basedata/fiscal_year_period_maint.html","parent.parent.main","images/admin.gif","物料维护","servlet/item/SearchItemServlet","parent.parent.main","images/admin.gif","分销商维护","basedata/client_maint.jsp","parent.parent.main","images/admin.gif","终端客户维护(医院)","basedata/temi_client_maint.html","parent.parent.main");
